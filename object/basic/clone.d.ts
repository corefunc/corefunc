export type TransferableObjectType = ArrayBuffer | ImageBitmap | MessagePort | OffscreenCanvas | ReadableStream | WritableStream;
/**
 ...
 * @since 0.3.20
 */
export declare function objectBasicClone<ValueType>(value: ValueType, transfer?: StructuredSerializeOptions["transfer"]): ValueType;
