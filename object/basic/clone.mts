import { checkIsPrimitive } from "../../check/is-primitive.mts";
 ...
 * @since 0.3.20
 */
export function objectBasicClone<ValueType>(value: ValueType, transfer?: TransferableObjectType[]): ValueType {
